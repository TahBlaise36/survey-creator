...
export default function CreateSurveyPage() {
  ...
  const saveSurvey = async (publish = false) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `Survey ${publish ? "published" : "saved as draft"} successfully`,
      })
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600">Build your survey by adding questions and customizing options</p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <Button onClick={() => saveSurvey(true)} disabled={!title.trim() || questions.length === 0 || isLoading}>
